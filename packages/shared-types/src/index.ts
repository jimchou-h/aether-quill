 ...
 * 维护说明：若本地 `openapi-typescript` 因 Windows 路径/校验无法完成全量重生成，可像 AQ-132 一样在 `paths` 与 `components.schemas` 中**手工增量对齐** OpenAPI 合同后再 `pnpm --filter @aether-quill/shared-types build`。
 */
...
export interface paths {
  ...
  '/api/projects/{id}/settings': {
     ...
     * @description 返回项目级写作设置（系统提示词、活跃人物、摘要注入数、生成温度等）
     */
    get: {
      parameters: {
        query?: never;
     ...
     * @description 更新项目级写作设置；未传字段保持不变
     */
    put: {
      parameters: {
        query?: never;
      ...
      responses: {
        ...
        /** @description Project or persona not found */
        404: {
          headers: {
            [name: string]: unknown;
          };
