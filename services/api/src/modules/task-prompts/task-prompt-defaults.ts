...
import {
  ...
  CHAPTER_PIPELINE_OUTLINE_REVISE_SYSTEM_PROMPT,
...
export const TASK_PROMPT_DEFINITIONS: TaskPromptDefinition[] = [
  ...
  {
    templateKey: CHAPTER_PIPELINE_OUTLINE_REVISE_TEMPLATE_KEY,
    name: '分步精修 · 大纲 AI 修订',
    defaultText: CHAPTER_PIPELINE_OUTLINE_REVISE_SYSTEM_PROMPT,
  },
  {
